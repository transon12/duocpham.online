...
$utf8_lookup = array(
    ...
    'romanize' => array(
        ...
        'ừ' => 'u','ứ' => 'u','ự' => 'u','ử' => 'u','ữ' => 'u','ỵ' => 'y','ỷ' => 'y','ỹ' => 'y','ó'=>'o','á'=>'a',
        // Upper accents
        ...
        'Ự' => 'U','Ử' => 'U','Ữ' => 'U','Ỵ' => 'Y','Ỷ' => 'Y','Ỹ' => 'Y','Á'=>'A','Ò'=>'O','Ó'=>'O',
        // Other
        'ǐ' => 'i','ǔ' => 'u','ǎ' => 'a','ǒ' => 'o','ǚ' => 'u','ǚ' => 'u','ǜ' => 'u','ǐ' => 'i','ǐ' => 'i', '@' => 'a','ỹ'=>'y','í'=>'i','ắ'=>'a',
        'ế'=>'e','ễ'=>'e','ệ'=>'e','à'=>'a','ộ'=>'o','ã'=>'a','ị'=>'i','ắ'=>'a','ứ'=>'u','ế'=>'e','ẩ'=>'a','è'=>'e','ố'=>'o','ờ'=>'o','ồ'=>'o','ả'=>'a',
        'ử'=>'u','ạ'=>'a','ọ'=>'o','ẵ'=>'a','õ'=>'o','ề'=>'e','ớ'=>'o','ủ'=>'u','ữ'=>'u','ầ'=>'a','ú'=>'u','ấ'=>'a','ù'=>'u'
    )
);
// @formatter:on