...
<html class="no-js" lang="">
    <head>
        ...
        <title>PHP.VN - Chi Tiết Giao Diện </title>
        ...
        <main>
            ...
            <section class="shop-banner-area pt-120 pb-90">
                 <div class="shape-slider">
                    <img class="shape shape-2  " src="<?= $base_url?>/public/assets/img/shape/shape2.png" alt="">
                    <img class="shape shape-4 " src="<?= $base_url?>/public/assets/img/shape/shape3.png" alt="">
                    <img class="shape shape-5 " src="<?= $base_url?>/public/assets/img/shape/shape-sq.png" alt="">
                    <img class="shape shape-6 " src="<?= $base_url?>/public/assets/img/shape/shape-c-2.png" alt="">
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-5">
                            <div class="product-details-img mb-0 theme-img">
                                <div class=" imgshow">
                                    <img src="https://www.elegantthemes.com/layouts/wp-content/uploads/2018/10/personal-trainer-landing-page-533x3781.jpg" alt="">
                                </div>
                                <div class="noteTheme">
                        ...
                        <div class="col-xl-6 col-lg-7">
                            <div class="product-details mb-30">
                                <div class="product-details-title mb-20">
                                    <h3>Helios Piranho Lamp</h3>
                                    <div class="price details-price pb-10">
                                        <span>$700.00</span>
                                    </div>
                                </div>
                                <p>Gói bố trí nhà cung cấp dịch vụ Internet sẽ ngay lập tức mang đến cho bạn sự rung cảm công nghệ mà bạn mong đợi từ nó. Mọi bố cục đều tập trung vào việc làm cho lời kêu gọi hành động trở nên nổi bật đồng thời cũng mang đến một thiết kế bắt mắt. Nói tóm lại, Gói bố trí nhà cung cấp dịch vụ Internet sẽ giúp bạn có được một trang web hiện đại và tuyệt đẹp ngay lập tức!</p>
                                <div class="product-cat mt-30 mb-20">
                                    <span>Category: </span>
                                    <a href="#">AppWe.vn,</a>
                                    <a href="#">Cooftech.vn,</a>
                                    <a href="#">Php.vn,</a>
                                </div>
                               ...
                               <div class="row">
                                   <div class="col-md-3 pb-3">
                                       <div class="card showImg"  >
                                              <img class="card-img-top " src="https://www.elegantthemes.com/layouts/wp-content/uploads/2018/10/personal-trainer-about-page-116x87.jpg" alt="Card image cap" data-img="https://www.elegantthemes.com/layouts/wp-content/uploads/2018/10/personal-trainer-about-page-533x2065.jpg" >
                                   ...
                                   <div class="col-md-3 pb-3">
                                       <div class="card showImg">
                                              <img class="card-img-top" src="https://www.elegantthemes.com/layouts/wp-content/uploads/2018/10/personal-trainer-blog-page-116x87.jpg" alt="Card image cap" data-img="https://www.elegantthemes.com/layouts/wp-content/uploads/2018/10/personal-trainer-blog-page-533x947.jpg">
                                              <div class="card-body text-center" style="padding: 6px">
                                               <span>Blog</span>
                                              </div>
                                            </div>
                                   ...
                                   <div class="col-md-3 pb-3">
                                       <div class="card showImg">
                                              <img class="card-img-top" src="https://www.elegantthemes.com/layouts/wp-content/uploads/2018/10/personal-trainer-contact-page-116x87.jpg" alt="Card image cap"
                                              data-img="https://www.elegantthemes.com/layouts/wp-content/uploads/2018/10/personal-trainer-contact-page-533x638.jpg">
                                              <div class="card-body text-center" style="padding: 6px">
                                               <span>Liên hệ</span>
                                              </div>
                                            </div>
                                   ...
                                   <div class="col-md-3 pb-3">
                                       <div class="card showImg">
                                              <img class="card-img-top" src="https://www.elegantthemes.com/layouts/wp-content/uploads/2018/10/personal-trainer-home-page-116x87.jpg" alt="Card image cap"
                                              data-img="https://www.elegantthemes.com/layouts/wp-content/uploads/2018/10/personal-trainer-home-page-533x1696.jpg">
                                              <div class="card-body text-center" style="padding: 6px">
