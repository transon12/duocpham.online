                            ...
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="<?= $base_url?>" class="logo"> 
                                        <img src="<?= $base_url?>/public/assets/img/logo2.png" class="logoWhite" alt="Thiết kế ứng dụng" width="100px">
                                ...
                                <div class="main-menu text-center">
                                    <nav id="mobile-menu">
                                        <ul>
                                            ...
                                            <li class="<?php if($_GET['code']== 'thiet-ke-mobile-app'){echo 'active';}?>"><a href="<?= $base_url?>/thiet-ke-mobile-app">Giới thiệu</a></li>
